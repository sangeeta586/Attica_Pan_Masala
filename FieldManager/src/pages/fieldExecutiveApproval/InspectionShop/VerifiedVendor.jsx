      ...
      <div className="flex-1 p-4 bg-gray-100">
        <div className="  w-full  p-2">
          ...
          <header className="bg-blue-300 rounded-md shadow-md p-4 flex justify-between items-center gap-4">
                    <h1 className="md:text-lg text-xs lg:text-xl font-bold text-gray-800 pl-12"> Verified Verification vendor list</h1>
                  ...
                  <tbody>
                    {paginatedShops().map((shop) => (
                      ...
                      >  <td className="border border-gray-300 p-4 text-left align-top">
                        ...
                        <td className="px-2 py-4 text-green-500">{shop.status}</td>
