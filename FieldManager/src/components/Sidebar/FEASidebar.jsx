...
const FEASidebar = ({ onClose }) => {
  ...
  const vendorMenuItems = [
    { text: "Vendor Not Interested", route: "/Field-Executive-Approval/Vendor-Not-Interested" },
    { text: "Pending Verification", route: "/Field-Executive-Approval/Pending-Verification" },
    { text: "Verified Vendor", route: "/Field-Executive-Approval/Verified-Verification" },
    { text: "Reject Vendor", route: "/Field-Executive-Approval/Reject-Verification" },
  ];
