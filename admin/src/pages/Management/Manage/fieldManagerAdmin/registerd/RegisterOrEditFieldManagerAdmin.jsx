...
const RegisterOrEditFieldManagerAdmin = ({
  onClose,
  fetchFiledManagers,
        ...
        try {
          ...
          if (response.ok) {
            ...
            Swal.fire({
              icon: "error",
              title: "Error",
              text: "Failed to fetch field manager details.",
            });
          }
        } catch (error) {
          console.error("Error fetching field manager details:", error);
          Swal.fire({
            icon: "error",
            title: "Error",
      ...
      try {
        ...
        if (response.ok) {
          Swal.fire({
            ...
            customClass: {
              confirmButton: "custom-ok-button", // Add your custom class here
            },
          }).then(() => {
            fetchFiledManagers();
            onClose();
          ...
          Swal.fire({
            ...
            customClass: {
              confirmButton: "custom-error-button", // Add a class for error button styling
            },
          });
        }
      } catch (error) {
      ...
      >
        <div className="flex justify-between gap-10 my-4">
          <Typography variant="h4" className="text-[#1e40af]">
            {isEdit ? "Update" : "Register"} Field Executive Approval
          </Typography>
          <ImCross
...
export default RegisterOrEditFieldManagerAdmin;
