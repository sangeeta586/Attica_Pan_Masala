...
import RegisterOrEditFieldManagerAdmin from "./RegisterOrEditFieldManagerAdmin";


const ListOfRegisterdFieldMangerAdmin = () => {
  ...
  try {
    ...
    // Transform the field managers data
    const adminFieldManagers = data.filter((manager) => manager.role === "Admin");
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="z-50 bg-white p-8 rounded-lg shadow-lg">
              <RegisterOrEditFieldManagerAdmin
                onClose={handleCloseModal}
                fetchFiledManagers={fetchFieldManagers}
              />
            </div>
          </div>
        )}
...
export default ListOfRegisterdFieldMangerAdmin;
